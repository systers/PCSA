...
/**
 * Safety Technology fragment, a member of the Tabbed Layout
 *
 * @author rohan
 * @since 2016-07-08
 */
public class SafetyTechnologyFragment extends Fragment {

    private ViewPager mPager;
    private PagerAdapter mPagerAdapter;
    int[] contentToDisplay = new int[]{R.string.safety_plan_4_concerns,R.string.safety_plan_4_action};
    Button actionButton;
